 ...
 */
u64 random_64(){
    u64 num1 = (u64)(custom_random()) & 0xFFFF; 
    u64 num2 = (u64)(custom_random()) & 0xFFFF;
    u64 num3 = (u64)(custom_random()) & 0xFFFF;
    u64 num4 = (u64)(custom_random()) & 0xFFFF;
...
#define t_table_size 0x1400000 // 20mb
// no hash entry found
...
char* wasm_uci_loop(char *command) {
    ...
    if(strncmp(command, "go", 2) == 0){
        // parse go
        char *bestmove = parse_go(command);
        return bestmove;
    }
}
